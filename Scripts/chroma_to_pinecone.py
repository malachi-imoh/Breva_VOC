...
class ChromaToPineconeMigrator:
    def __init__(
        ...
        index_name: str = "voc-index-2025-q3"
    ):
        """
...
def main():
    ...
    parser.add_argument(
        '--chroma-dir',
        type=str,
        default="C:\\chroma_db_test",   # Windows-friendly default
        help='Path to ChromaDB persistence directory'
    )
    parser.add_argument(
        '--pinecone-api-key',
        type=str,
        default=os.getenv("PINECONE_API_KEY"),   # load from .env
        help='Pinecone API key'
    )
    parser.add_argument(
        '--collection-name',
        type=str,
        default="voc_responses",
        help='ChromaDB collection name'
    )
    parser.add_argument(
        '--index-name',
        type=str,
        default="voc-index-2025-q3",   # new run
